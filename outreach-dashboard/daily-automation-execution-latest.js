window.DAILY_AUTOMATION_EXECUTION_LATEST = {
  ...
  "userVisibleStatus": "Customer development was not performed. Blockers: homepage_only_contact_path_requires_verification (36); official_website_contact_channel (24); website_contact_capability_not_verified (24).",
  "recoveryHint": "Refill the high-ICP pool with 29 verified leads or unblock existing website/social leads before the next run. Confirm the official social profile and safe message entry before rerunning Google-discovered social outreach.",
  "recoveryActions": [
    {
  ...
  "summary": {
    ...
    "refillNeeded": 29,
    "executableCompanies": 47,
    "executableReserveTarget": 130,
    "executableReserveNeeded": 83,
    "executableByChannel": {
      "linkedin": 4,
      "facebook": 7,
      "instagram": 1,
  ...
  "completedAt": "2026-08-14T07:27:43.585Z"
};
