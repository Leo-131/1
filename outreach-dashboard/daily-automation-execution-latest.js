window.DAILY_AUTOMATION_EXECUTION_LATEST = {
  ...
  "userVisibleStatus": "Daily target already reached at 100/100; no additional first touch was attempted.",
  "recoveryActions": [],
  "skipped": [
    {
    ...
    {
      "id": "google-customer-stoner-andrews-website-contact",
      "company": "Stoner Andrews",
      "action": "email_priority",
      "platform": "website_form",
      "reason": "official_website_contact_channel"
    },
    ...
    {
      "id": "google-customer-north-branch-traders-website-contact",
      "company": "North Branch Traders",
      "action": "email_priority",
      "platform": "website_form",
      "reason": "official_website_contact_channel"
    },
    {
      "id": "google-customer-rep-first-website-contact",
      "company": "Rep First",
      "action": "email_priority",
      "platform": "website_form",
      "reason": "official_website_contact_channel"
    ...
    {
      "id": "google-customer-roi-recreation-outfitters-website-contact",
      "company": "ROI Recreation Outfitters",
      "action": "email_priority",
      "platform": "website_form",
      "reason": "official_website_contact_channel"
    },
    {
      "id": "google-customer-black-dog-sales-group-website-contact",
      "company": "Black Dog Sales Group",
      "action": "email_priority",
      "platform": "website_form",
      "reason": "official_website_contact_channel"
    },
    ...
    {
      "id": "google-customer-kns-reps-website-contact",
      "company": "KNS Reps",
      "action": "email_priority",
      "platform": "website_form",
      "reason": "official_website_contact_channel"
    ...
    {
      "id": "google-customer-west-bay-trading-company-website-contact",
      "company": "West Bay Trading Company",
      "action": "email_priority",
      "platform": "website_form",
      "reason": "official_website_contact_channel"
    },
    {
      "id": "google-customer-canadawide-sports-website-contact",
    ...
    {
      "id": "google-customer-hicks-inc-website-contact",
      "company": "Hicks Inc",
      "action": "email_priority",
      "platform": "website_form",
      "reason": "official_website_contact_channel"
    ...
    {
      "id": "google-customer-round-the-wheel-collective-website-contact",
      "company": "Round The Wheel Collective",
      "action": "email_priority",
      "platform": "website_form",
      "reason": "official_website_contact_channel"
    },
    {
      "id": "google-customer-classic-products-international-website-contact",
      "company": "Classic Products International",
      "action": "email_priority",
      "platform": "website_form",
      "reason": "official_website_contact_channel"
    },
    {
      "id": "google-customer-outdoor-equipment-distributors-website-contact",
      "company": "Outdoor Equipment Distributors",
      "action": "email_priority",
      "platform": "website_form",
      "reason": "official_website_contact_channel"
    },
    ...
    {
      "id": "google-customer-jamsca-solutions-website-contact",
      "company": "JAMSCA Solutions",
      "action": "email_priority",
      "platform": "website_form",
      "reason": "official_website_contact_channel"
    },
    ...
    {
      "id": "google-customer-summit-sales-nw-website-contact",
      "company": "Summit Sales NW",
      "action": "verify_target",
      "platform": "website_form",
      "reason": "homepage_only_contact_path_requires_verification"
    },
    ...
    {
      "id": "google-customer-adventure-marketing-group-website-contact",
    ...
    {
      "id": "google-customer-mtnstuff-website-contact",
      "company": "MTNSTUFF",
      "action": "verify_target",
      "platform": "website_form",
      "reason": "homepage_only_contact_path_requires_verification"
    ...
    {
      "id": "google-customer-pacific-crest-trading-website-contact",
      "company": "Pacific Crest Trading",
      "action": "verify_target",
      "platform": "website_form",
      "reason": "homepage_only_contact_path_requires_verification"
    },
    ...
    {
      "id": "google-customer-mountain-exposure-website-contact",
      "company": "Mountain Exposure",
      "action": "verify_target",
      "platform": "website_form",
      "reason": "homepage_only_contact_path_requires_verification"
    },
    ...
    {
      "id": "google-customer-pinnacle-outdoor-group-website-contact",
    ...
    {
      "id": "google-customer-vert-outdoors-website-contact",
      "company": "VERT Outdoors",
      "action": "verify_target",
      "platform": "website_form",
      "reason": "homepage_only_contact_path_requires_verification"
    },
    ...
    {
      "id": "google-customer-evergreen-outdoor-group-website-contact",
      "company": "Evergreen Outdoor Group",
      "action": "verify_target",
      "platform": "website_form",
      "reason": "homepage_only_contact_path_requires_verification"
    },
    {
      "id": "google-customer-ground-up-sales-website-contact",
      "company": "Ground Up Sales",
      "action": "verify_target",
      "platform": "website_form",
      "reason": "homepage_only_contact_path_requires_verification"
    },
    ...
    {
      "id": "google-customer-specialty-sports-reps-website-contact",
      "company": "Specialty Sports Reps",
      "action": "verify_target",
      "platform": "website_form",
      "reason": "homepage_only_contact_path_requires_verification"
    },
    ...
    {
      "id": "google-customer-elite-outdoor-sports-marketing-website-contact",
      "company": "Elite Outdoor Sports Marketing",
      "action": "verify_target",
      "platform": "website_form",
      "reason": "homepage_only_contact_path_requires_verification"
    },
    ...
    {
      "id": "google-customer-7-summits-sports-website-contact",
      "company": "7 Summits Sports",
      "action": "verify_target",
      "platform": "website_form",
      "reason": "homepage_only_contact_path_requires_verification"
    },
    ...
    {
      "id": "google-customer-mindful-outdoor-sales-website-contact",
      "company": "Mindful Outdoor Sales",
      "action": "verify_target",
      "platform": "website_form",
      "reason": "homepage_only_contact_path_requires_verification"
    },
    ...
    {
      "id": "google-customer-roam-sales-agency-website-contact",
      "company": "Roam Sales Agency",
      "action": "verify_target",
      "platform": "website_form",
      "reason": "homepage_only_contact_path_requires_verification"
    },
    ...
    {
      "id": "google-customer-professional-marketing-inc-website-contact",
      "company": "Professional Marketing Inc",
      "action": "verify_target",
      "platform": "website_form",
      "reason": "website_contact_capability_not_verified"
    }
  ...
  "queueGoalStatus": {
    ...
    "confirmedToday": 100,
    "reached": true,
    "action": "Daily confirmed-company target reached; preserve the hard cap and do not send more first touches."
  },
  "checkpointAudit": {
  ...
  "completedAt": "2026-08-12T12:35:35.388Z"
};
