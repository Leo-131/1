window.DAILY_AUTOMATION_EXECUTION_LATEST = {
  ...
  "userVisibleStatus": "Customer development was not performed. Blockers: homepage_only_contact_path_requires_verification (31); official_website_social_channel_verified (30); official_public_business_email_verified (17).",
  "recoveryHint": "Refill the high-ICP pool with 100 verified leads or unblock existing website/social leads before the next run. Confirm the official social profile and safe message entry before rerunning Google-discovered social outreach.",
  "recoveryActions": [
    {
  ...
  "blockerCounts": {
    ...
    "official_website_social_channel_verified": 30,
  ...
  "completedAt": "2026-09-02T04:07:46.260Z"
};
