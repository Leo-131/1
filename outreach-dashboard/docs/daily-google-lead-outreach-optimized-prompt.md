...
- The bounded research catalog may retain up to 600 evidence-backed candidates so adding North America reserve rows cannot truncate previously verified prospects. This discovery capacity is not sending capacity and never changes the 100-distinct-company Shanghai-day hard cap.
