...
const DIRECTORY_REFILL_CANDIDATES = [
  ...
  ['Bergfreunde', 'Germany', 'https://www.bergfreunde.eu/', '', 91],
  ['Bergzeit', 'Germany', 'https://www.bergzeit.de/', '', 90],
  ['Globetrotter', 'Germany', 'https://www.globetrotter.de/', '', 92],
  ['Fritz Berger', 'Germany', 'https://www.fritz-berger.de/', '', 91],
  ['Camping Wagner', 'Germany', 'https://www.campingwagner.de/', '', 90],
...
].map(([company, country, url, instagramUrl, fitScore]) => ({
  company,
  country,
  url,
  contactUrl: url,
  instagramUrl,
  segment: 'verified outdoor, camping, travel and consumer electronics retail channel',
  customerType: 'key_account',
  refillSeed: true,
  fitScore,
