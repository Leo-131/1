window.DAILY_AUTOMATION_EXECUTION_LATEST = {
  ...
  "userVisibleStatus": "Customer development was not performed. Blockers: homepage_only_contact_path_requires_verification (25); website_contact_capability_not_verified (25); official_website_contact_channel (18).",
  "recoveryHint": "Refill the high-ICP pool with 32 verified leads or unblock existing website/social leads before the next run. Verify the recipient as an official public business email before enabling email outreach. Confirm the official social profile and safe message entry before rerunning Google-discovered social outreach.",
  "recoveryActions": [
    {
  ...
  "completedAt": "2026-08-05T08:51:32.592Z"
};
