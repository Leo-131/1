window.DAILY_AUTOMATION_EXECUTION_LATEST = {
  ...
  "userVisibleStatus": "Customer development was not performed. Blockers: missing_verified_profile_url (16); official_website_contact_channel (8); homepage_only_contact_path_requires_verification (6).",
  "recoveryHint": "Refill the high-ICP pool with 66 verified leads or unblock existing website/social leads before the next run. Add a verified Facebook or Instagram profile URL before retrying social outreach. Confirm the official social profile and safe message entry before rerunning Google-discovered social outreach.",
  "recoveryActions": [
    {
      "reason": "daily_queue_goal_not_reached",
      "action": "Refill high-ICP customer pool",
      "description": "Add or unblock 66 verified high-ICP leads to reach the daily 100 target.",
      "hint": "Refill the high-ICP pool with 66 verified leads or unblock existing website/social leads before the next run.",
      "target": 100,
      "potentialPool": 34,
      "refillNeeded": 66
    },
  ...
  "blockerCounts": {
    ...
    "concrete_google_discovered_major_customer_facebook": 3
  },
  "queueGoalStatus": {
    "target": 100,
    "potentialPool": 34,
  ...
  "completedAt": "2026-07-20T23:02:58.122Z"
};
