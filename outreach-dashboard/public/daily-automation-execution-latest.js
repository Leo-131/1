window.DAILY_AUTOMATION_EXECUTION_LATEST = {
  ...
  "userVisibleStatus": "Customer development was not performed. Blockers: official_website_contact_channel (37); homepage_only_contact_path_requires_verification (27); official_public_business_email_verified (26).",
  "recoveryHint": "Refill the high-ICP pool with 30 verified leads or unblock existing website/social leads before the next run. Confirm the official social profile and safe message entry before rerunning Google-discovered social outreach.",
  "recoveryActions": [
    {
  ...
  "blockerCounts": {
    "official_website_contact_channel": 37,
  ...
  "completedAt": "2026-08-22T07:07:47.715Z"
};
