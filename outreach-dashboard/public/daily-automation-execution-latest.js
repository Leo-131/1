window.DAILY_AUTOMATION_EXECUTION_LATEST = {
  ...
  "userVisibleStatus": "Customer development was not performed. Blockers: homepage_only_contact_path_requires_verification (44); social_profile_not_first_party_verified (20); missing_verified_profile_url (16).",
  "recoveryHint": "Refill the high-ICP pool with 7 verified leads or unblock existing website/social leads before the next run. Add a verified Facebook or Instagram profile URL before retrying social outreach.",
  "recoveryActions": [
    {
  ...
  "blockerCounts": {
    "homepage_only_contact_path_requires_verification": 44,
    "social_profile_not_first_party_verified": 20,
  ...
  "completedAt": "2026-08-04T08:44:07.960Z"
};
