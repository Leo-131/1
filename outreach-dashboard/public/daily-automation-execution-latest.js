window.DAILY_AUTOMATION_EXECUTION_LATEST = {
  ...
  "userVisibleStatus": "Customer development was not performed. Blockers: official_website_social_channel_verified (41); official_public_business_email_verified (22); website_contact_capability_not_verified (9).",
  "recoveryHint": "Refill the high-ICP pool with 68 verified leads or unblock existing website/social leads before the next run. Confirm the official social profile and safe message entry before rerunning Google-discovered social outreach.",
  "recoveryActions": [
    {
      "reason": "daily_queue_goal_not_reached",
      "action": "Refill high-ICP customer pool",
      "description": "Add or unblock 68 verified high-ICP leads to reach the daily 100 target.",
      "hint": "Refill the high-ICP pool with 68 verified leads or unblock existing website/social leads before the next run.",
      "target": 100,
      "potentialPool": 32,
      "refillNeeded": 68
    },
  ...
  "blockerCounts": {
    ...
    "homepage_only_contact_path_requires_verification": 3,
  ...
  "candidateSelectionAudit": [
    {
      ...
      "readiness": {
        ...
        "evidenceUrl": "https://transcon.co.uk/"
      },
      "hasTarget": true,
    ...
    },
    {
      ...
      "readiness": {
        "ready": true,
        "gate": "official_business_email",
        "evidenceUrl": "https://stellabluesales.com/"
      },
      "hasTarget": true,
      "inCandidatePool": false,
      "sameDayCompanyBlocked": false,
    ...
    },
    {
      ...
      "readiness": {
        "ready": true,
        "gate": "official_business_email",
        "evidenceUrl": "https://www.beaveroutdoor.ca/contact-us.html"
      },
      "hasTarget": true,
      "inCandidatePool": false,
      "sameDayCompanyBlocked": false,
    ...
    },
    {
      ...
      "readiness": {
        "ready": true,
        "gate": "official_business_email",
        "evidenceUrl": "https://smithpower.co.za/brands/"
      },
      "hasTarget": true,
      "inCandidatePool": false,
      "sameDayCompanyBlocked": false,
    ...
    },
    {
      ...
      "readiness": {
        "ready": true,
        "gate": "official_business_email",
        "evidenceUrl": "https://www.diversicor.co.za/"
      },
      "hasTarget": true,
      "inCandidatePool": false,
      "sameDayCompanyBlocked": false,
    ...
    },
    {
      ...
      "readiness": {
        "ready": true,
        "gate": "official_business_email",
        "evidenceUrl": "https://www.nicholasyale.co.za/about-us"
      },
      "hasTarget": true,
      "inCandidatePool": false,
      "sameDayCompanyBlocked": false,
    ...
    },
    {
      ...
      "readiness": {
        "ready": true,
        "gate": "official_business_email",
        "evidenceUrl": "https://www.oukitel.co.za/collections/sale"
      },
      "hasTarget": true,
      "inCandidatePool": false,
      "sameDayCompanyBlocked": false,
  ...
  "completedAt": "2026-08-26T22:07:28.230Z"
};
