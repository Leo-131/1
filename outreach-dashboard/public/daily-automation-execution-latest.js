window.DAILY_AUTOMATION_EXECUTION_LATEST = {
  ...
  "userVisibleStatus": "Customer development was not performed. Blockers: homepage_only_contact_path_requires_verification (25); website_contact_capability_not_verified (25); official_website_contact_channel (17).",
  "recoveryHint": "Refill the high-ICP pool with 33 verified leads or unblock existing website/social leads before the next run. Verify the recipient as an official public business email before enabling email outreach. Confirm the official social profile and safe message entry before rerunning Google-discovered social outreach.",
  "recoveryActions": [
    {
      "reason": "daily_queue_goal_not_reached",
      "action": "Refill high-ICP customer pool",
      "description": "Add or unblock 33 verified high-ICP leads to reach the daily 100 target.",
      "hint": "Refill the high-ICP pool with 33 verified leads or unblock existing website/social leads before the next run.",
      "target": 100,
      "potentialPool": 67,
      "refillNeeded": 33
    },
  ...
  "blockerCounts": {
    ...
    "official_website_contact_channel": 17,
  ...
  "completedAt": "2026-08-10T09:06:57.912Z"
};
