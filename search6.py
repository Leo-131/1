...
for q in queries:
    ...
    try:
        with urllib.request.urlopen(req, timeout=15) as resp:
            ...
            results.append({"query": q["keyword"], "result": result})
    except Exception as e:
        results.append({"query": q["keyword"], "error": str(e)})

# Write results to file as JSON
with open(r"C:\Users\23889\.qclaw\workspace\search_results.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=2)

print("Done - results written to search_results.json")
